...
export default function FacultyProfilePage() {
  ...
  const pageMetadata = useMemo(() => {
    if (!faculty) return createMetadata({ title: "Faculty Profile", description: "View faculty profile and reviews." })
    return createMetadata({
      title: `${faculty.name} - ${faculty.title}`,
      description: `View profile, courses, and student reviews for ${faculty.name}, ${faculty.title} in the ${faculty.department} department.`,
  ...
  return (
    <>
      <Head>
        ...
        {/* Render other metadata fields from pageMetadata as needed */}
        {faculty && (
          <script
            ...
            dangerouslySetInnerHTML={{
              __html: JSON.stringify([
                ...
                ...reviews.map(review => jsonLdReview({
