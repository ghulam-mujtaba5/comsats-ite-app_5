        ...
        <div className="container mx-auto px-4 py-12 max-w-6xl">
          ...
          <header className="mb-12 text-center">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 mb-6">
              Excellence in Education in the Scenic Hills of Khyber Pakhtunkhwa
            </p>
            <div className="flex items-center justify-center gap-2 text-gray-500">
              <MapPin className="h-5 w-5" />
              <span>University Road, Abbottabad, KPK, Pakistan</span>
            </div>
          </header>
          ...
          <div className="grid md:grid-cols-4 gap-6 mb-12">
            ...
            <Card className="text-center">
              <CardContent className="pt-6">
                ...
                <div className="text-3xl font-bold text-green-600">2003</div>
          ...
          <section className="mb-12">
            <h2 className="text-3xl font-bold mb-6">About COMSATS Abbottabad</h2>
            <Card>
              <CardContent className="pt-6">
                <p className="text-lg leading-relaxed mb-4">
                  COMSATS University Abbottabad campus, established in 2003, is nestled in the picturesque hills of Khyber Pakhtunkhwa. 
                  Known for its serene environment and quality education, the campus offers an ideal setting for academic excellence 
                  and personal growth.
                </p>
                <p className="text-lg leading-relaxed mb-4">
                  The campus features state-of-the-art facilities including modern computer labs, well-equipped engineering workshops, 
                  a comprehensive library, and sports facilities. With a focus on research and innovation, COMSATS Abbottabad has 
                  produced thousands of graduates who excel in their professional careers across Pakistan and internationally.
                </p>
                <p className="text-lg leading-relaxed">
                  The campus is particularly renowned for its engineering programs and has established strong industry linkages 
                  to ensure students receive practical exposure alongside theoretical knowledge.
                </p>
              </CardContent>
            </Card>
          </section>
                ...
                <div className="grid md:grid-cols-3 gap-6">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm opacity-90">+92-992-383591-6</p>
                      <p className="text-sm opacity-90">Fax: +92-992-383441</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm opacity-90">info@abbottabad.comsats.edu.pk</p>
                      <p className="text-sm opacity-90">admissions@abbottabad.comsats.edu.pk</p>
                    </div>
                  </div>
                </div>
              </CardContent>
          ...
          <section className="text-center bg-gray-50 dark:bg-gray-900 p-8 rounded-xl">
            <h2 className="text-2xl font-bold mb-4">Ready to Join COMSATS Abbottabad?</h2>
