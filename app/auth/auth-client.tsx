...
export default function AuthClient() {
  ...
  <div className="absolute top-20 right-20 w-6 h-6 bg-primary/40 rotate-45 animate-bounce animate-delay-1000" />
  <div className="absolute bottom-32 left-20 w-8 h-8 bg-blue-500/40 rounded-full animate-bounce animate-delay-3000" />
  <div className="absolute top-1/3 right-1/3 w-4 h-4 bg-purple-500/40 rotate-45 animate-bounce animate-delay-5000" />
  <div className="absolute top-2/3 left-1/4 w-5 h-5 bg-green-500/40 rounded-full animate-bounce animate-delay-7000" />
      </div>
