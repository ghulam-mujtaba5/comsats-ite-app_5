...
function NewsSkeleton() {
  return (
    <div className="py-16 md:py-20 lg:py-24 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-[#fafbfc] to-white dark:from-[#12161b] dark:to-[#0f1115] backdrop-blur-xl">
      <div className="app-container max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
          {[...Array(3)].map((_, i) => (
            <div key={i} className="group border border-[rgba(107,114,128,0.15)] dark:border-[rgba(255,255,255,0.15)] rounded-2xl bg-white/80 dark:bg-[#1a1f27]/80 backdrop-blur-3xl shadow-[0_10px_20px_rgba(60,60,60,0.19),0_6px_6px_rgba(60,60,60,0.23)] hover:shadow-[0_14px_28px_rgba(60,60,60,0.25),0_10px_10px_rgba(60,60,60,0.22)] transition-all duration-300">
...
function CommunitySkeleton() {
  return (
    <div className="py-16 md:py-20 lg:py-24 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-white to-[#fafbfc] dark:from-[#0f1115] dark:to-[#12161b] backdrop-blur-xl">
      <div className="app-container max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
          {[...Array(2)].map((_, i) => (
            <div key={i} className="border border-[rgba(107,114,128,0.15)] dark:border-[rgba(255,255,255,0.15)] rounded-2xl bg-white/80 dark:bg-[#1a1f27]/80 backdrop-blur-3xl shadow-[0_10px_20px_rgba(60,60,60,0.19),0_6px_6px_rgba(60,60,60,0.23)] p-5 sm:p-6">
  ...
  return (
    <div className="py-16 md:py-20 lg:py-24 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-white to-[#fafbfc] dark:from-[#0f1115] dark:to-[#12161b] backdrop-blur-xl">
      <div className="app-container max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
          {[...Array(3)].map((_, i) => (
            <div key={i} className="border border-[rgba(107,114,128,0.15)] dark:border-[rgba(255,255,255,0.15)] rounded-2xl bg-white/80 dark:bg-[#1a1f27]/80 backdrop-blur-3xl shadow-[0_10px_20px_rgba(60,60,60,0.19),0_6px_6px_rgba(60,60,60,0.23)]">
  ...
  return (
    <div className="py-16 md:py-20 lg:py-24 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-[#fafbfc] to-white dark:from-[#12161b] dark:to-[#0f1115] backdrop-blur-xl">
      <div className="app-container max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="border border-[rgba(107,114,128,0.15)] dark:border-[rgba(255,255,255,0.15)] rounded-3xl bg-white/90 dark:bg-[#1a1f27]/90 backdrop-blur-3xl shadow-[0_14px_28px_rgba(60,60,60,0.25),0_10px_10px_rgba(60,60,60,0.22)] p-8 sm:p-10 md:p-12 max-w-3xl mx-auto">
...
export default function HomePage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-white via-[#f5f7fa] to-[#e8ecf3] dark:from-[#0f1115] dark:via-[#181c22] dark:to-[#1a1f27] -mt-8 sm:-mt-12">
      ...
      <div className="fixed inset-0 pointer-events-none overflow-hidden">
        ...
        <div className="absolute inset-0 bg-gradient-to-b from-white/30 via-[#f5f7fa]/50 to-white/80 dark:from-[#0f1115]/40 dark:via-[#181c22]/60 dark:to-[#0f1115]/90 backdrop-blur-[1px]" />
      </div>
