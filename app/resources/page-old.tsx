...
export const metadata: Metadata = {
  title: 'COMSATS Academic Resources – Study Materials & Learning Tools',
  description: 'Access curated academic resources including study guides, tutorials, documentation and learning materials for COMSATS University students.',
  alternates: { canonical: (process.env.NEXT_PUBLIC_SITE_URL || 'https://campusaxis.site') + '/resources' },
  keywords: ['COMSATS resources','study materials','academic resources','learning tools','university resources','student guides'],
  openGraph: {
    title: 'COMSATS Academic Resources – Study Materials & Learning Tools',
    description: 'Curated academic resources and study materials for COMSATS University students.',
    url: (process.env.NEXT_PUBLIC_SITE_URL || 'https://campusaxis.site') + '/resources'
  },
  twitter: {
    title: 'COMSATS Academic Resources',
    description: 'Study guides, tutorials and learning materials for COMSATS students.'
  }
}
...
export default function ResourcesPage() {
  ...
  const collection = jsonLdCollectionPage({
    name: 'COMSATS Academic Resources',
    description: 'Curated collection of academic resources, study materials and learning tools for university students.',
    path: '/resources'
  })
  return (
    <>
