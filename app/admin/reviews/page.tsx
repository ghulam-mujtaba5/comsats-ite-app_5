  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 dark:from-gray-900 dark:via-gray-900 dark:to-gray-900">
      ...
      <div className="relative overflow-hidden">
        ...
        {/* Content Section */}
        <main className={`${styles.section} px-4 py-8`}>
          {error && (
          ...
          <div className="glass-card border border-slate-200 dark:border-slate-700 dark:border-slate-200 dark:border-slate-700 rounded-2xl backdrop-blur-xl bg-white/40 dark:bg-slate-900/40 p-4 flex flex-col md:flex-row gap-3 items-stretch md:items-center justify-between">
