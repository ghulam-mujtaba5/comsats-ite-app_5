    ...
    <AdminGuard fallback={
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-indigo-50/20 dark:from-slate-950 dark:via-blue-950/30 dark:to-indigo-950/20">
        <div className="flex items-center justify-center min-h-screen p-6">
          <div className="glass-secondary border border-slate-200 dark:border-slate-700 dark:border-slate-200 dark:border-slate-700 rounded-3xl p-8 backdrop-blur-xl bg-white/60 dark:bg-slate-900/60 text-center space-y-4 max-w-md">
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-indigo-50/20 dark:from-slate-950 dark:via-blue-950/30 dark:to-indigo-950/20">
        ...
        <div className="relative overflow-hidden">
          ...
          <div className={`relative ${adminStyles.section} pt-12 pb-8`}>
            <div className="glass-secondary border border-slate-200 dark:border-slate-700 dark:border-slate-200 dark:border-slate-700 rounded-3xl p-8 mb-8 backdrop-blur-xl bg-white/40 dark:bg-slate-900/40">
        ...
        <div className={`${adminStyles.section} ${adminStyles.spaceY6} pb-12`}>
          ...
          {/* Filter Section */}
          <Card className="glass-secondary border border-slate-200 dark:border-slate-700 dark:border-slate-200 dark:border-slate-700 rounded-2xl backdrop-blur-xl bg-white/40 dark:bg-slate-900/40">
            ...
            <Card className="glass-card border border-slate-200 dark:border-slate-700 dark:border-slate-200 dark:border-slate-700 rounded-2xl backdrop-blur-xl bg-white/40 dark:bg-slate-900/40 hover:shadow-xl transition-all duration-300">
              ...
              <CardContent className="relative">
                {filteredRows.length === 0 && !loading ? (
                  <Card className="glass-card border border-slate-200 dark:border-slate-700 dark:border-slate-200 dark:border-slate-700 rounded-2xl backdrop-blur-xl bg-white/40 dark:bg-slate-900/40 p-8 text-center">
                        ...
                        <tbody>
                          {loading
                            ? Array.from({ length: 6 }).map((_, i) => (
                                <tr key={`sk-${i}`} className="border-t border-slate-200 dark:border-slate-700 dark:border-slate-600/40">
                            ...
                            : filteredRows.map((r) => (
                                <tr
                                  key={r.id}
                                  className="border-t border-slate-200 dark:border-slate-700 dark:border-slate-600/40 hover:bg-white/30 dark:hover:bg-slate-700/30 transition-colors cursor-pointer"
                                  onClick={() => editRow(r)}
                                  title={`Edit ${r.name}`}
