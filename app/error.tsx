  ...
  return (
    <div className="min-h-screen bg-mesh overflow-hidden relative flex flex-col">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute top-20 right-20 w-4 h-4 bg-red-500/30 rotate-45 animate-bounce" style={{ animationDelay: '1s' }} />
        <div className="absolute bottom-32 left-20 w-6 h-6 bg-orange-500/30 rounded-full animate-bounce" style={{ animationDelay: '3s' }} />
        <div className="absolute top-1/3 right-1/3 w-3 h-3 bg-yellow-500/30 rotate-45 animate-bounce" style={{ animationDelay: '5s' }} />
      </div>
