    ...
    if (typeof localStorage !== 'undefined' && typeof window !== 'undefined' && typeof document !== 'undefined') {
      ...
      <body className={`${GeistSans.variable} ${manrope.variable} antialiased bg-background text-foreground dark:bg-slate-900`}>
        ...
        <div className="fixed inset-0 pointer-events-none -z-10">
          ...
          <div className="absolute top-1/4 left-1/4 w-64 h-64 md:w-96 md:h-96 bg-gradient-to-r from-pink-500/20 to-rose-500/20 rounded-full blur-3xl animate-pulse dark:from-blue-500/10 dark:to-indigo-500/10" />
          <div className="absolute bottom-1/4 right-1/4 w-64 h-64 md:w-96 md:h-96 bg-gradient-to-r from-purple-500/20 to-fuchsia-500/20 rounded-full blur-3xl animate-pulse dark:from-indigo-500/10 dark:to-slate-500/10" style={{ animationDelay: '2s' }} />
          <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-gradient-to-br from-pink-500/10 via-purple-500/10 to-indigo-500/10 rounded-full blur-3xl dark:from-slate-800 dark:via-slate-900 dark:to-slate-900" />
        </div>
