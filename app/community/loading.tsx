  ...
  return (
    <div className="min-h-screen bg-mesh overflow-hidden relative flex items-center justify-center">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute -bottom-40 -left-40 w-96 h-96 bg-gradient-to-br from-blue-500/15 to-cyan-500/15 rounded-full blur-3xl animate-pulse float" style={{ animationDelay: '2s' }} />
      </div>
