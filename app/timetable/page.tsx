      ...
      <main className="flex-1 py-12 px-4">
        <div className={layout.section}>
          ...
          {adminLoading ? (
            ...
            <Card className="mb-8 bg-white/90 dark:bg-slate-800/90 shadow-xl rounded-3xl transition-all duration-300">
          ...
          {loading ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {filteredDocs.map((doc) => (
                <Card key={doc.id} className="bg-white/90 dark:bg-slate-800/90 shadow-lg hover:shadow-xl rounded-2xl transition-all duration-300 hover:-translate-y-1 group">
