...
export function ContactPageClient() {
  ...
  <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] bg-gradient-to-br from-primary/10 to-blue-500/10 rounded-full blur-3xl animate-pulse float animate-delay-4000" />
        
        {/* Floating geometric shapes */}
  <div className="absolute top-20 right-20 w-4 h-4 bg-primary/30 rotate-45 animate-bounce animate-delay-1000" />
  <div className="absolute top-1/3 right-1/3 w-3 h-3 bg-blue-500/30 rotate-45 animate-bounce animate-delay-5000" />
      </div>
