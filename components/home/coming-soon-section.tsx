          ...
          <Card className="inline-block p-6 border bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm max-w-3xl mx-auto glass-card-premium glass-border-glow glass-depth">
            <div className="flex flex-col sm:flex-row items-center gap-4">
              ...
              <div className="mt-4 sm:mt-0">
                <a href="/report-issue" className="inline-flex items-center px-5 py-2.5 bg-gradient-to-r from-primary to-indigo-600 text-primary-foreground rounded-xl hover:from-primary/90 hover:to-indigo-700 transition-all shadow-lg hover:shadow-xl glass-interactive">
                  Share Feedback
                </a>
              </div>
            </div>
