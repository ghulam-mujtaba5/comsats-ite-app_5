    ...
    <section className="py-20 px-4 bg-gradient-to-b from-background/80 to-muted/30 glass-primary" aria-labelledby="features-heading" ref={ref}>
      <div className="app-container">
        ...
        <div className={`text-center mb-xl md:mb-2xl transition-all duration-700 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
          ...
          <h2 id="features-heading" className="text-display-3 sm:text-display-2 md:text-display-1 font-extrabold text-balance mb-md md:mb-lg">
          ...
          <p className="text-body-lg md:text-body-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
                ...
                >
                  <Card className="group relative h-full overflow-hidden border border-white/30 bg-card/90 backdrop-blur-3xl rounded-2xl shadow-2xl transition-all duration-300 hover:shadow-2xl glass-primary focus-ring" tabIndex={0}>
                    ...
                    <CardHeader className="relative z-10 pb-4 sm:pb-6">
                      ...
                      <CardTitle id={`feature-title-${index}`} className="text-heading-2 sm:text-heading-1 font-semibold mb-sm sm:mb-md group-hover:text-primary transition-colors">
                        {feature.title}
                      </CardTitle>
                    ...
                    <CardContent className="relative z-10 pt-0">
                      ...
                      <Button 
                        variant="ghost" 
                        className="w-full justify-between hover:bg-muted group/btn p-2 sm:p-3 h-auto rounded-lg sm:rounded-xl relative overflow-hidden text-sm sm:text-base interactive-scale focus-glow"
                        asChild
                      >
          ...
          >
            <Card className="inline-block p-8 sm:p-10 md:p-12 border border-white/20 bg-card/80 backdrop-blur-2xl shadow-2xl rounded-2xl sm:rounded-3xl max-w-3xl mx-auto glass-primary">
              <div className="space-y-6 sm:space-y-8">
                ...
                <h3 id="cta-heading" className="text-heading-1 sm:text-heading-1 md:text-display-3 font-bold">Ready to Transform Your Academic Experience?</h3>
                ...
                <div className="flex flex-col sm:flex-row gap-md sm:gap-lg justify-center pt-lg sm:pt-xl">
                  <Button 
                    size="lg" 
                    className="text-body-md sm:text-body-lg px-6 sm:px-8 py-3 sm:py-4 rounded-lg sm:rounded-xl bg-gradient-to-r from-primary to-indigo-600 hover:from-primary/90 hover:to-indigo-700 text-primary-foreground shadow-lg hover:shadow-xl transition-all duration-300 relative overflow-hidden group interactive-scale focus-glow"
                    asChild
                  >
                  ...
                  <Button 
                    variant="outline" 
                    size="lg" 
                    className="text-body-md sm:text-body-lg px-6 sm:px-8 py-3 sm:py-4 rounded-lg sm:rounded-xl border-2 hover:shadow-md transition-all duration-300 interactive-scale focus-glow"
                    asChild
                  >
