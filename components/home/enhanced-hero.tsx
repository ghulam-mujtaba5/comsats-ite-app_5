...
export function EnhancedHero() {
  ...
  return (
    <section className="relative flex items-center overflow-hidden px-4 sm:px-6 lg:px-8 bg-transparent py-12 sm:py-16 lg:py-20" aria-labelledby="hero-heading" ref={ref} role="region">
