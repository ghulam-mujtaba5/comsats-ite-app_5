    ...
    <section className="py-20 px-4 bg-gradient-to-b from-muted/20 to-background">
      <div className="container mx-auto max-w-6xl">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-12">
          ...
          <Button variant="outline" size="lg" className="hidden sm:flex px-6 py-3 text-base rounded-xl border-2" asChild>
        ...
        {loading ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {items.slice(0, maxCount).map((item) => (
              ...
              <Card className="group hover:shadow-xl transition-all duration-500 overflow-hidden border bg-card/80 backdrop-blur-sm hover:-translate-y-1">
                <div className="aspect-video relative overflow-hidden">
                  ...
                  />
                  <Badge className="absolute top-4 left-4 bg-primary text-primary-foreground text-sm px-3 py-1 rounded-full shadow-md">Published</Badge>
                </div>
        ...
        <div className="text-center mt-8 sm:hidden">
          <Button variant="outline" size="lg" className="px-6 py-3 text-base rounded-xl border-2" asChild>
            <Link href="/news-events">
              View All News
              <ArrowRight className="ml-2 h-4 w-4" />
            </Link>
