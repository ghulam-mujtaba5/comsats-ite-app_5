...
const aspectRatioVariants = cva(
  "",
  {
    variants: {
      variant: {
        default: "",
        glass: "bg-white/10 backdrop-blur-xl border border-white/20 rounded-lg shadow-glass overflow-hidden",
        "glass-subtle": "bg-white/5 backdrop-blur-lg border border-white/10 rounded-lg shadow-glass-sm overflow-hidden",
      },
    },
    defaultVariants: {
      variant: "default",
