...
CREATE TABLE public.events (
  ...
  category character varying NOT NULL CHECK (category::text = ANY (ARRAY['academic'::character varying, 'cultural'::character varying, 'sports'::character varying, 'workshop'::character varying, 'seminar'::character varying]::text[])),
...
CREATE TABLE public.news_items (
  ...
  title character varying NOT NULL,
  content text NOT NULL,
  category character varying NOT NULL CHECK (category::text = ANY (ARRAY['academic'::character varying, 'event'::character varying, 'announcement'::character varying, 'deadline'::character varying]::text[])),
  is_important boolean DEFAULT false,
  image_url text,
  author_id uuid,
