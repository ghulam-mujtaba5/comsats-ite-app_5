...
export function SkipNavigation() {
  return (
    <a
      href="#main-content"
      className="sr-only focus:not-sr-only focus:absolute focus:top-4 focus:left-4 focus:z-50 focus:bg-background focus:text-slate-900 dark:text-white focus:px-4 focus:py-2 focus:rounded-md focus:ring-2 focus:ring-primary focus:outline-none transition-all"
    >
